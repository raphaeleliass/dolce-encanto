...
function Hero() {
  return (
    <section className="mx-auto mt-24 flex w-full max-w-[350px] flex-col rounded-3xl bg-gradient-to-tr from-rose-600 to-rose-400 px-6 py-16 shadow-lg md:mt-0 md:max-w-3xl md:flex-row md:from-rose-700 md:via-rose-400 md:to-rose-300 md:px-16 lg:max-w-6xl">
      <div className="flex flex-col gap-1 md:w-1/2">
        <p className="font-Inter text-center font-light text-white drop-shadow-xl md:text-left">
          Dolce Encanto Doceria
        </p>
        <h1 className="font-LobsterTwo text-center text-6xl font-bold text-white md:text-left md:text-6xl lg:pr-12 lg:text-7xl">
